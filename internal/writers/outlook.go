...
func (w *OutlookWriter) WriteFile(ctx context.Context, collection *model.CalendarCollection, filePath string) error {
...
func (w *OutlookWriter) Write(ctx context.Context, collection *model.CalendarCollection, writer io.Writer) error {
